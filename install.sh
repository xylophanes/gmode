...
#---------------------------------------------------------------------------
# Check for libiconv (would be nice to have the option of not needing it!!)
#---------------------------------------------------------------------------
#--------
# 64 bit
#--------

if [ ! -e /usr/lib64/libiconv.so ] ; then
	echo ""
	echo "    install ERROR: 64 bit iconv library not found"
	echo ""
...
if [ ! -e /usr/lib/libiconv.so ] ; then
	echo ""
	echo "    install ERROR: 32 bit iconv library not found"
	echo ""
